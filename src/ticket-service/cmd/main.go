...
func main() {
	...
	router.HandleFunc("/api/v1/tickets", handlers.CancelTicketHandler).Methods("PUT", "OPTIONS")
	router.HandleFunc("/api/v1/tickets/{uid}", handlers.DeleteTicketHandler).Methods("DELETE", "OPTIONS")
